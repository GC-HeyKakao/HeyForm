...
function CreateSurvey() {
	...
	return (
		<>
			<Row>
				<Nav variant="pills" defaultActiveKey="create" className="center-wrapper-150" style={{ padding: 10 }} onSelect={(e) => setViewSwitch(e)}>
...

			{
				viewSwitch == 'create' ?
					<>
						<Row style={{ paddingTop: 10 }}>
							...
							<Col style={{ marginRight: "1%" }}>
								<Preview savedQsList={savedQsList} curQs={curQs} curQsItemList={curQsItemList}
						...
						<Row>
							<Col >
								<div className="center-wrapper-120">
									<Button variant="primary" className="center" style={{ marginTop: 30 }}>설문 제작 완료</Button>
								</div>
							</Col>
						</Row>
					</>
					...
					// 공유 탭
					<>
						<Row style={{paddingTop: 20, paddingLeft: 50}}>
							<Col md={"2"}>
