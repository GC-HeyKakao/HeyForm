...
//             className={
//               qnaList[index].show
//                 ? "styles.faqCardAnswer"
//                 : "styles.faqCardAnswer styles.faqCardNone"
//             }
//           >
//             <span className={styles.answerMark}>A.</span>
//             <span className={styles.FAQCardAnswer}>{item.answer}</span>
//           </div>
//         </div>
//       );
//     };
...
//         /> */}
//         <div className={styles.fqaParent}>
//           <div className={styles.faqList} style={{paddingTop:20}}>
